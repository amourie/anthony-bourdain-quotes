...
//console.log("year is " + currentQuoteObj.year);
  ...
  $('#quote-box p.source').text(currentQuoteObj.source);
  $('#quote-box span.citation').text(currentQuoteObj.citation);
  $('#quote-box span.year').text(currentQuoteObj.year);
  currentQuoteObj.usedFlag = true;
  console.log("flag now is " + currentQuoteObj.usedFlag);
...
function randomQuote()
{
  ...
  if (arrLength > 0) {
    ...
    console.log("before resetting length " + quotes.length);
    quotes = initArray();
